...
define( 'YOURLS_DB_PASS', '15701f51370ca487a421' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'vps' );
...
define( 'YOURLS_SITE', 'https://vps-yourls.zhz2v8.easypanel.host/yourls' );
...
define( 'YOURLS_COOKIEKEY', 'yourls' );
